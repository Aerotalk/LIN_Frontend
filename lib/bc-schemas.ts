...
export const bcStep1Schema = z.object({
    fullName: z.string()
...
export const bcStep2Schema = z.discriminatedUnion("type", [
    z.object({
...
export type BCStep1Data = z.infer<typeof bcStep1Schema>;
export type BCStep2Data = z.infer<typeof bcStep2Schema>;
